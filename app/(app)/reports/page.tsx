...
export default async function ReportsPage({
  ...
  return <div className="grid gap-5">
    ...
    <div className="flex items-start gap-2 rounded-xl border border-[var(--border)] bg-white p-4 text-xs text-[var(--muted-foreground)]"><CheckCircle2 size={17} className="mt-0.5 shrink-0 text-[var(--success)]"/><span><strong>Nguyên tắc đối soát:</strong> mua khí lấy số thực nhận PHC; thuê vỏ lấy số vỏ cuối từng ngày; XL-45 tính bồn-ngày sau 15 ngày miễn phí; vận chuyển tính đúng 1 cước cho mỗi Phiếu giao NCC; trả vỏ đi cùng không tạo cước mới. Không phân bổ cước vận chuyển vào từng loại khí nếu chưa có quy tắc phân bổ chính thức.</span></div>
  </div>;
}
